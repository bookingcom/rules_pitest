...
some other ruleset that depends on rules_pitest, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_pitest=$(pwd)/rules_pitest"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_pitest` on your system will point to this folder.
