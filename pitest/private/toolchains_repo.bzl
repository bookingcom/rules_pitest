...
# By default all these toolchains are registered by the pitest_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:pitest_toolchain",
    toolchain_type = "@com_bookingcom_rules_pitest//pitest:toolchain_type",
)
""".format(
            platform = platform,
